...
NOTICE: This file was modified to match Tensor shape expectations in GeneDisco and the GeneDisco licensing header was
        added. The Source work at
        https://github.com/BlackHC/batchbald_redux/blob/master/batchbald_redux/consistent_mc_dropout.py did not
        include a license header but was also licensed under Apache 2.0.
"""
